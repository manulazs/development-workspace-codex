...
| `python3 skills/migrate-to-codex/scripts/cli.py --validate-target .` | 0 | pass;   ok: .codex/agents/security_auditor.toml - agent TOML has required fields.<br>  ok: .codex/agents/version_control_manager.toml - agent TOML has required fields.<br>  ok: AGENTS.md - 6.1KB is under the 32KB review threshold.<br>  ok: codex-global/AGENTS.md - 4.5KB is under the 32KB review threshold. |
